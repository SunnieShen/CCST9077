...
- 他们的角色是**一对被“量子纠缠”连接的双胞胎角色**
- 导演相信唯有选择真正的双胞胎,他们才会心有灵犀, 在舞台上摩擦出火花, 展现最好的戏剧效果. 因此, 他们需要通过 **“心灵同步度”** 来证明自己有资格扮演这对特殊角色
- 但你们本不是双胞胎, 如何通过这场同步测试呢?
### Before audition
chat with your partner Alice: 但你们本不是双胞胎, 如何通过这场同步测试呢? 我们只要搞清楚同步测试的原理就一定能通过测试, 之后我相信我们的表演一定能达到“所谓的双生的默契水准”(这里要纠正一下价值观, 不要把整个故事建立在“欺瞒”的基础上)
### At the scene
-  导演：“欢迎参加《纠缠双生》的试镜。要扮演这对量子纠缠的双胞胎，你们需要证明你们的同步率超越经典。”
- 导演解释规则：“测试仪会给两位发送不同的‘情感指令’（问题），你们需要做出‘反应’（回答）” 
==“在没有提前沟通的情况下，两人能否在任何组合的指令下都做出符合剧本逻辑的联合反应？”==
```
情感指令（场景类型）：
- 指令0：日常场景（平静、温馨）
- 指令1：冲突场景（紧张、激烈）
...
反应（表演风格）：
- 按钮0：内敛表演（如沉默、凝视、细微表情）
- 按钮1：外放表演（如肢体舒展、语调高昂、情绪外露）
```
...
- **玩家P选项：**
    ...
    1. 开怀大笑，手势生动，语调起伏，轻拍桌子共鸣（外放）
        
    2. 微笑倾听，偶尔点头，回应简洁，手指轻抚杯沿（内敛）
        
- **搭档A选项：**
    
    1. 高声讲述趣事，模仿朋友表情，表情夸张（外放）
        
    2. 安静注视对方，微微前倾，眼神温暖（内敛）
...
- **玩家P选项：**
    ...
    1. 快乐哼歌，转动喷壶洒出水花，对植物说话鼓励（外放）
        
    2. 俯身细心检查叶片，轻抚花瓣，神态宁静（内敛）
        
- **搭档A选项：**
    
    1. 崩溃大哭，抓住对方摇晃，声音嘶哑（外放）
        
    2. 瞬间僵住，面色苍白，嘴唇微颤，强忍泪水（内敛）
...
- **玩家P选项：**
    ...
    1. 高声争执，大幅度挥舞手臂，表情愤怒（外放）
        
    2. 紧握物品不放，眼神锐利，声音低沉克制（内敛）
        
- **搭档A选项：**
    
    1. 读到精彩处轻声赞叹，比划情节，表情丰富（外放）
        
    2. 安静翻阅书页，偶尔微蹙眉头，姿态放松（内敛）
...
- **玩家P选项：**
    ...
    1. 惊恐尖叫，高举双手颤抖，语无伦次（外放）
        
    2. 保持冷静，眼神警惕，声音平稳试图谈判（内敛）
        
- **搭档A选项：**
    
    1. 崩溃求饶，试图躲藏，表情扭曲（外放）
        
    2. 缓慢移动身体，压低声音，寻找逃脱机会（内敛）
...
- **玩家P选项：**
    ...
    1. 兴奋指认旧照，高声讲述故事，表情生动（外放）
        
    2. 凝视照片，眼神温柔，指尖轻触影像，沉默（内敛）
        
- **搭档A选项：**
    
    1. 猛地站起大声抗议，手指对方，情绪激动（外放）
        
    2. 面色一沉，快速翻阅文件，眼神锐利思考（内敛）
...
| 轮次  | 指令类型    | 玩家P场景 | 搭档A场景 | 正确答案组合（表演风格）       |
| --- | ------- | ----- | ----- | ------------------ |
| 1   | 日常 + 日常 | 咖啡馆交谈 | 咖啡馆交谈 | 相同风格：内敛/内敛 或 外放/外放 |
| 2   | 日常 + 冲突 | 花园浇水  | 亲人事故  | 相同风格：内敛/内敛 或 外放/外放 |
| 3   | 冲突 + 日常 | 争夺物品  | 公园阅读  | 相同风格：内敛/内敛 或 外放/外放 |
| 4   | 冲突 + 冲突 | 持枪威胁  | 持枪威胁  | 不同风格：内敛/外放 或 外放/内敛 |
| 5   | 日常 + 冲突 | 整理相册  | 法庭证据  | 相同风格：内敛/内敛 或 外放/外放 |

--- 

### Interlude
导演被一通电话叫走, 面试暂停. 我和partner在后台踱步, 偶然发现一个非常古早的录像机?, 介绍量子物理的基础概念,(两个人想到什么....有什么动机....?比如录像机上有神奇的标签跟量子物理有什么关联)翻开script/录像机?
(基本概念介绍, 到CHSH视频损坏停止)
##### answer the **MC question** to unlock more tutorial materials
**Question1:**  
In quantum mechanics, if a photon is in a superposition of "horizontal polarization" and "vertical polarization", this means:
A. It is a mixture of both horizontal and vertical polarization, and upon measurement, it will collapse into one of them with certain probabilities.  
B. It is actually horizontally polarized, but we just don't know it yet.  
C. It is rapidly switching between the two polarization states.  
D. It is neither horizontal nor vertical, but in an independent state.
**Correct Answer: A**  
**Explanation:**  
Superposition is a fundamental feature of quantum systems. The system is in a linear combination of multiple eigenstates, and only upon measurement does it randomly collapse to a definite state, with probabilities given by the coefficients.

**Question2:**  
Two entangled photons, A and B, are separated to a large distance. When photon A is measured and found to be horizontally polarized, an immediate measurement of photon B will show:
A. Photon B must be vertically polarized (opposite to A).  
B. Photon B's polarization is completely random and independent of A.  
C. Photon B's polarization is the same as A (horizontal).  
D. Photon B's polarization depends on when A was measured.
**Correct Answer: C** (if the entangled state is of the form |HH>+|VV>)  
_Alternatively, a more general correct statement could be:_  
"The polarization of B is strongly correlated with the result of A, and the specific correlation depends on the form of the entangled state."
**Explanation:**  
Entanglement implies that the states of the two particles are inseparable. Measuring one immediately affects the correlated state of the other, regardless of distance.

**Question3:**  
The most appropriate metaphor for "quantum steering" is:
A. Like a remote control, one party can actively control the state of the other.  
B. By choosing the measurement setting, one party can "steer" the state distribution of the other party in a way that cannot be explained by a classical local model.  
C. The two particles are like connected by a string, so that when one moves, the other follows.  
D. One party can send information faster than light to the other.
**Correct Answer: B**  
**Explanation:**  
Quantum steering is a concept that lies between entanglement and Bell nonlocality. It describes the ability of one party, by choosing a measurement setting, to "steer" the state of the other party. This steering effect cannot be simulated by local hidden variable models and reflects the directional nature of quantum correlations





Alice: 这是不是跟我们刚刚做的trial test 很像? 
me: 为什么这里标注了 quantum superposition, entanglement, steering, and quantum machine? 
Alice: 难道我们的test利用了qubits? 如果真是这样的话...(推理这个游戏的游戏规则)
(unlock 插画 + quantum device)
##### CHSH mechanism
- 规则
- quantum measuring device
##### compared with audition
- 规则(QA pattern)
	- 场景一：两人都收到日常场景
	    → 他们应该展现出日常相处的自然同步。  
		→ **考察日常默契**
    - **场景二：一人日常、一人冲突**  
	    → 这是**最大的挑战**！在真实的戏剧情境中，这是最难处理的：  
	- **场景三：两人都收到冲突场景（红光）**  
	    → 他们必须表现出“互补性”，一人内敛一人外放，形成戏剧张力。  
	    → **考察危机中的差异化配合能力**
- 原理
##### Strategy? 
Alice: 那么我们应该用什么策略
4. random as trial test
5. always [0,0]
6. use quantum machine

我们刚把录像机放回原处并商议完, 听见脚步声,导演恰好接完电话返回剧场
...
(模拟, 计算概率)
### Ending
与partner聊天,等待面试结果, 我们对于搞学习到的量子物理知识还意犹未尽:
- 思考我通过和我的partner通过是不是也是一种entanglement呢?
...
The screen fades into a stunning poster for *Entangled Siblings: The Quantum Play*. Your names and Alice’s shine beneath the title.

A final message appears, letter by letter:

> *“This is not magic. It is quantum mechanics.*  
> *We have witnessed: true默契 can transcend any script.*  
> *Bell’s inequality is not a wall—it is a horizon, illuminated by the light of understanding.”*
